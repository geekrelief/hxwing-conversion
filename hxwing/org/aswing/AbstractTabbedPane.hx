...
class AbstractTabbedPane extends Container {
    ...
    var titles:Array<Dynamic>;
    var icons:Array<Dynamic>;
    var tips:Array<Dynamic>;
    var enables:Array<Dynamic>;
    var visibles:Array<Dynamic>;
    var model:SingleSelectionModel;
	 ...
	 */
	override function insertImp(i:Int, com:Component, ?constraints:Dynamic=null):Void{
	...
	function insertProperties(i:Int, ?title:String="", ?icon:Icon=null, ?tip:String=null):Void{
	 ...
	 */	
	override function removeAtImp(i:Int):Component{
	...
	function removeProperties(i:Int):Void{
	 ...
	 * @see #removeTabAt()
	 */
	public override function remove(com:Component):Component{
	...
	function __modelStateChanged(e:InteractiveEvent):Void{
	...
	function insertToArray(arr:Array<Dynamic>, i:Int, obj:Dynamic):Void{
		if(i < 0){
			arr.push(obj);
		}else{
			arr.insert(i, obj);
	...
	function removeFromArray(arr:Array<Dynamic>, i:Int):Void{
		if(i < 0){
			arr.pop();
		}else{
			arr.splice(i, 1);
