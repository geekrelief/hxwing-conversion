...
class BasicLabelUI extends BaseComponentUI {
	...
	public override function uninstallUI(c:Component):Void{
 	...
 	function installDefaults(b:JLabel):Void{
 	...
 	function uninstallDefaults(b:JLabel):Void{
 		LookAndFeel.uninstallBorderAndBFDecorators(b);
 	}
 	
 	function installComponents(b:JLabel):Void{
 	...
 	function uninstallComponents(b:JLabel):Void{
 		b.removeChild(textField);
 	}
 	
 	function installListeners(b:JLabel):Void{
 	}
	
 	function uninstallListeners(b:JLabel):Void{
 	}
     ...
     */
    function paintText(b:JLabel, textRect:IntRectangle, text:String):Void{
     ...
     */
    function paintIcon(b:JLabel, g:Graphics2D, iconRect:IntRectangle):Void{
     ...
     */
    function getLabelPreferredSize(b:JLabel, icon:Icon, text:String):IntDimension{
