...
import Import_org_aswing_plaf_basic_background;
import Import_org_aswing_plaf_basic_border;
import Import_org_aswing_plaf_basic_cursor;
import Import_org_aswing_plaf_basic_frame;
import Import_org_aswing_plaf_basic_icon;
import org.aswing.plaf.basic.tree.BasicExpandControl;
import Import_org_aswing_resizer;
import Import_org_aswing_tree;

/**
 * Note: All empty object should be null or an UIResource instance.
 * Undefined/UIResource instance means not set, if it is null, means that user set it to be null, so LAF value will not be use. 
 * @author iiley
 */
class BasicLookAndFeel extends org.aswing.LookAndFeel {
	
	
	
	var NULL_COLOR:ASColorUIResource ;
	var NULL_FONT:ASFontUIResource ;
	...
	function initClassDefaults(table:UIDefaults):Void{
	...
	function initSystemColorDefaults(table:UIDefaults):Void{
			...
			var i:Int=0;
			while (i<defaultSystemColors.length){
	...
	function initSystemFontDefaults(table:UIDefaults):Void{
	...
	function initCommonUtils(table:UIDefaults):Void{
	...
	function initComponentDefaults(table:UIDefaults):Void{
