...
class BasicListUI extends BaseComponentUI {
    ...
    var paintFocusedCell:ListCell;
    var focusGraphics:Graphics2D;
    var focusRectangle:IntRectangle;
    var focusGraphicsOwner:Graphics;
    ...
    function paintCurrentCellFocus():Void{
    ...
    function paintCellFocusWithIndex(index:Int):Void{
    ...
    function paintCellFocus(cellComponent:Component):Void{
    	if(focusGraphicsOwner != null)
    ...
    function __onSelectionChanged(e:SelectionEvent):Void{
    	var fm:FocusManager = FocusManager.getManager(list.stage);
    ...
    function __onItemMouseDown(e:ListItemEvent):Void{
    ...
    function __onItemClick(e:ListItemEvent):Void{
