...
class BaseComponentUI implements ComponentUI {
    ...
    function getDefaultFocusColorInner():ASColor{
    	return getColor("focusInner");
    }
    function getDefaultFocusColorOutter():ASColor{
    	return getColor("focusOutter");
    }
    	
	function paintBackGround(c:Component, g:Graphics2D, b:IntRectangle):Void{
		if(c.isOpaque()){
