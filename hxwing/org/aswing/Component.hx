...
class Component extends AWSprite {
	...
	public var d_visible(getD_visible, setD_visible) : Bool;
	public var d_x(getD_x, setD_x) : Float;
	public var d_y(getD_y, setD_y) : Float;
	 ...
	 * The max interval time to judge whether click was continuously.
	 */
	static var MAX_CLICK_INTERVAL:Int = 400;
	
	var ui:ComponentUI;
	public var container:Container;
	var clientProperty:HashMap;
	
	var awmlID:String;
	var awmlIndex:Float;
	var awmlNamespace:String;
	...
	var cachePreferSizes:Bool;
	var cachedPreferredSize:IntDimension;
	var cachedMinimumSize:IntDimension;
	var cachedMaximumSize:IntDimension;
	var constraints:Dynamic;
	var uiElement:Bool;
	
	var drawTransparentTrigger:Bool ;
	var valid:Bool;
	var bounds:IntRectangle;
	var readyToPaint:Bool;
	...
	var dragAcceptableInitiator:Dictionary;
	var dragAcceptableInitiatorAppraiser:Dynamic;
	...
	function __componentAdded(e:Event):Void{
		if(isUIElement()){
	...
	function makeAllTobeUIElement(dis:DisplayObject):Void{
		if(dis == null){
			return;
		}
	 ...
	 */	
	function setD_visible(value:Bool):Bool{
		super.visible = value;
		return value;
	}
	...
	public function getFont():ASFont{
        if (font != null && font != DefaultEmptyDecoraterResource.NULL_FONT) {
        	...
        	return cast(parent, Component).getFont();
        }else{
	 ...
	 * @see  #setSize()
	 */
	public function setWidth(width:Float):Float{
		setSizeWH(Std.int(width), getHeight());
        return width;
	}
	/**
	 ...
	 * @see  #setSize()
	 */	
	function setHeight(height:Float):Float{
	...
	public function removeDragAcceptableInitiator(com:Component):Void{
		if(dragAcceptableInitiator != null){
			...
			Reflect.deleteField(dragAcceptableInitiator, com);
		}
	}
	 ...
	 */
	public function setDragAcceptableInitiatorAppraiser(func:Dynamic):Void{
	 ...
	 */
	function setD_x(value:Float):Float{
		super.x = value;
		return value;
	}
	 ...
	 */	
	function setD_y(value:Float):Float{
		super.y = value;
		return value;
	}
	 ...
	 */
	function countMinimumSize():IntDimension{		
		if(ui != null){
	 ...
	 */
	function countMaximumSize():IntDimension{		
		if(ui != null){
	 ...
	 */
	function countPreferredSize():IntDimension{
		if(ui != null){
	...
	function isDirectReturnSize(s:IntDimension):Bool{
		return s != null && (s.width != -1 && s.height != -1);
	}
	
	function mixSetSize(counted:IntDimension, setted:IntDimension):IntDimension{
		if(setted != null){
			if(setted.width != -1){
	...
	function clearPreferSizeCaches():Void{
    	cachedMaximumSize = null;
    	cachedMinimumSize = null;
    	cachedPreferredSize = null;
	}
	 ...
	 */
	function paint(b:IntRectangle):Void{
		graphics.clear();
	...
	static var bg_trigger_brush:SolidBrush = new SolidBrush(new ASColor(0, 0));
	...
	function layoutClipAndTrigger(paintBounds:IntRectangle):Void{
		if(paintBounds == null){
	 ...
	 * @see #getPaintBounds()
	 */
	function getPaintBoundsInRoot():IntRectangle{
     ...
     */
    function transferFocusWithDirection(dir:Float):Bool{
	...
	function fireDragRecognizedEvent(touchedChild:Component):Void{
	...
	var _lastClickPoint:IntPoint;
	var clickCount:Int;
	function __mouseClick(e:MouseEvent):Void{
	...
	function __mouseDown(e:MouseEvent):Void{
	 ...
	 */
	function getFocusTransmit():Component{
		return null;
	}
	
	function checkRequestFocusWhenMouseDown(e:MouseEvent):Void{
	...
	var pressingPoint:IntPoint;
	function __mouseUp(e:MouseEvent):Void{
		stopListernDragRec();
	}
	...
	function __rollOut(e:MouseEvent):Void{
		stopListernDragRec();
	}
	function stopListernDragRec():Void{
	...
	function __focusIn(e:FocusEvent):Void{
	...
	function __focusOut(e:FocusEvent):Void{
