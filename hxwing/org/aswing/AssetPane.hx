...
class AssetPane extends Container {
    ...
    var customScale:Int;
    var actualScale:Int;
    var floorOriginalSize:IntDimension;
    var floorOriginalScaleX:Float;
    var floorOriginalScaleY:Float;
    var hadscaled:Bool;
    var offsetX:Float;
    var offsetY:Float;
	 ...
	 * @see #setAsset()
	 */
	public function new(?asset:DisplayObject=null, ?prefferSizeStrategy:Int) {
		super();

        if(prefferSizeStrategy == null){
            prefferSizeStrategy = PREFER_SIZE_IMAGE;
        }
	...
	function storeOriginalScale():Void{
		if(asset != null){
	 ...
	 * </ul>
	 */
	public function setPrefferSizeStrategy(p:Int):Void{
	 ...
	 */
	public function getPrefferSizeStrategy():Int{
    ...
    public function setVerticalAlignment(?alignment:Int):Void {
        if(alignment == null){
            alignment = AsWingConstants.CENTER;
        }
    ...
    public function setHorizontalAlignment(?alignment:Int):Void {
        if(alignment == null){
            alignment = AsWingConstants.RIGHT;
        }
	 ...
	 * Aligns floorMC clip. 
	 */
	function alignFloor(?b:IntRectangle=null):Void {
		// for child classes which redefines floorMC
	 ...
	 */
	override function countPreferredSize():IntDimension{
	...
	function countFloorSize():IntDimension {
		var b:IntRectangle = getPaintBounds();
	...
	function setLoaded(b:Bool):Void{
		floorLoaded = b;
	}
	
	function setAssetOriginalSize(size:IntDimension):Void{
