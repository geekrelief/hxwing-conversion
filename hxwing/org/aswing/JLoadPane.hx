...
import Import_flash_net;
import Import_flash_system;
...
class JLoadPane extends AssetPane {
	...
	var loader:Loader;
	var loadedError:Bool;
	var urlRequest:URLRequest;
	var context:LoaderContext;
	var regularAssetContainer:DisplayObjectContainer;
	...
	public override function setAsset(asset:DisplayObject):Void{
	 ...
	 */
	function setLoadedAsset(asset:DisplayObject):Void{
		if(assetContainer == regularAssetContainer){
			assetContainer = loader;
			if (this.contains(regularAssetContainer)){
				if(this.asset != null && regularAssetContainer.contains(this.asset) != null){
	...
	function __onLoadComplete(e:Event):Void{
	...
	function __onLoadInit(e:Event):Void{
		dispatchEvent(new Event(Event.INIT));
	}
	
	function __onLoadProgress(e:ProgressEvent):Void{
		dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS, false, false, e.bytesLoaded, e.bytesTotal));
	}
	
	function __onLoadStart(e:Event):Void{
		dispatchEvent(new Event(Event.OPEN));
	}
	
	function __onUnload(e:Event):Void{
		dispatchEvent(new Event(Event.UNLOAD));
	}
	
	function __onLoadHttpStatus(e:HTTPStatusEvent):Void{
