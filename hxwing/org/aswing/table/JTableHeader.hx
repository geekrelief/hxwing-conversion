...
class JTableHeader extends Container, implements TableColumnModelListener {
	...
	static var uiClassID:String = "TableHeaderUI";
	var table:JTable;
	var columnModel:TableColumnModel;
	var reorderingAllowed:Bool;
	var resizingAllowed:Bool;
	var resizingColumn:TableColumn;
	var defaultRenderer:TableCellFactory;
	var rowHeight:Int;
	 ...
	 */	
	function createDefaultColumnModel():TableColumnModel{
	 ...
	 */	
	function createDefaultRenderer():TableCellFactory{
