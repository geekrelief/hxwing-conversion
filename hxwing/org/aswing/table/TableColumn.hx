...
class TableColumn extends EventDispatcher {
	...
	var maxWidth:Int;
	var headerRenderer:TableCellFactory;
	var headerValue:Dynamic;
	var cellRenderer:TableCellFactory;
	...
	function firePropertyChangeIfReallyChanged(propertyName:String, oldValue:Dynamic, newValue:Dynamic):Void{
