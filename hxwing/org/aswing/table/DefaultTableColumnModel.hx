...
class DefaultTableColumnModel implements TableColumnModel {
	...
	var columnMargin:Int;
	/** List of TableColumnModelListener */
	var listenerList:Array<Dynamic>;
	/** Column selection allowed in this column model */
	var columnSelectionAllowed:Bool;
	...
	public function getSelectedColumns():Array<Dynamic>{
		if (selectionModel != null){
			...
			var rv:Array<Dynamic> = new Array();
			var i:Int = iMin;
			while (i <= iMax){
	...
	function fireColumnAdded(e:TableColumnModelEvent):Void{
	...
	function fireColumnRemoved(e:TableColumnModelEvent):Void{
		var listeners:Array<Dynamic> = listenerList;
		// Process the listeners last to first, notifying
		// those that are interested in this event
		var i:Int = (listeners.length - 1);
	...
	function fireColumnMoved(e:TableColumnModelEvent):Void{
		var listeners:Array<Dynamic> = listenerList;
		// Process the listeners last to first, notifying
		// those that are interested in this event
		var i:Int = (listeners.length - 1);
	...
	function fireColumnSelectionChanged(firstIndex:Int, lastIndex:Int, programmatic:Bool):Void{
		var listeners:Array<Dynamic> = listenerList;
		// Process the listeners last to first, notifying
		// those that are interested in this event
		var i:Int = (listeners.length - 1);
	...
	function fireColumnMarginChanged():Void{
		var listeners:Array<Dynamic> = listenerList;
		// Process the listeners last to first, notifying
		// those that are interested in this event
		var i:Int = (listeners.length - 1);
	...
	function __selectionChanged(e:SelectionEvent):Void{
		fireColumnSelectionChanged(e.getFirstIndex(), e.getLastIndex(), e.isProgrammatic());
	}
	
	function createSelectionModel():ListSelectionModel{
	 ...
	 */	
	function recalcWidthCache():Void{
	...
	function invalidateWidthCache():Void{
		totalColumnWidth = -1;
	}
