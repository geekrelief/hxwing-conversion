...
class DefaultTableModel extends AbstractTableModel {
	...
	var columnNames:Array<Dynamic>;
	
	var columnsEditable:Array<Dynamic>;
	...
	public function initWithRowcountColumncount(rowCount:Int, columnCount:Int):DefaultTableModel {
		return initWithNamesRowcount(new Array(), rowCount); 
	}
	...
	public function initWithNamesRowcount(columnNames:Array<Dynamic>, rowCount:Int):DefaultTableModel {
		setDataNames(new Array(), columnNames);
		return this;
	}
	...
	static function nonNullArray(v:Array<Dynamic>):Array<Dynamic> { 
	...
	function justifyRows(from:Int, _to:Int):Void { 
	...
	static function gcd(i:Int, j:Int):Int {
		return (j == 0) ? i : gcd(j, i%j); 
	}

	static function rotate(v:Array<Dynamic>, a:Int, b:Int, shift:Int):Void {
		var size:Int = b - a; 
