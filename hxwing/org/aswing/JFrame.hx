...
import Import_org_aswing_resizer;
...
class JFrame extends JWindow {
	 ...
	 * @see #setState()
	 */
	public static var NORMAL:Int = 0; //0
	/**
	 * @see #setState()
	 */
	public static var ICONIFIED:Int = 2; //10
	/**
	 * @see #setState()
	 */
	public static var MAXIMIZED_HORIZ:Int = 4;  //100
	/**
	 * @see #setState()
	 */
	public static var MAXIMIZED_VERT:Int = 8;  //1000
	/**
	 * @see #setState()
	 */
	public static var MAXIMIZED:Int = 12;  //1100
	//-----------------------------------------
	
	/**
	 * @see #setDefaultCloseOperation()
	 */
	public static var DO_NOTHING_ON_CLOSE:Int = 0;
	/**
	 * @see #setDefaultCloseOperation()
	 */
	public static var HIDE_ON_CLOSE:Int = 1;
	/**
	 * @see #setDefaultCloseOperation()
	 */
	public static var DISPOSE_ON_CLOSE:Int = 2;
	
	/**
	 * For title bar changed event property name.
	 */
	public static var PROPERTY_TITLE_BAR:String = "titleBar";
	//--------------------------------------------------------
	...
	var maximizedBounds:IntRectangle;
	var lastNormalStateBounds:IntRectangle;
	...
	var resizer:Resizer;
	var resizerController:ResizerController;
    ...
    public override function setUI(newUI:ComponentUI):Void{
    	if(Std.is( newUI, FrameUI)){
    		...
    		throw ("JFrame just accept FrameUI instance!!!");
    	}
    }
	...
	function setSizeToFixMaxmimized():Void{
	 ...
	 */
	function precessIconified(?programmatic:Bool=true):Void{
		doSubPopusVisible();
	 ...
	 */
	function precessRestored(?programmatic:Bool=true):Void{
		doSubPopusVisible();
	 ...
	 */
	function precessMaximized(?programmatic:Bool=true):Void{
		doSubPopusVisible();
		dispatchEvent(new FrameEvent(FrameEvent.FRAME_MAXIMIZED, programmatic));
	}
	
	function doSubPopusVisible():Void{
	...
	public override function shouldOwnedPopupGroundVisible(popup:JPopup):Bool{
	...
	override function initModalMC():Void{
		super.initModalMC();
		getModalMC().addEventListener(MouseEvent.MOUSE_DOWN, __flashModelFrame);
	}
	
	function __flashModelFrame(e:MouseEvent):Void{
		if(getFrameUI() != null){
