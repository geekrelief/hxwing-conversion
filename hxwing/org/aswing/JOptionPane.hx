...
class JOptionPane extends JPanel {
	...
	public static var OK:Int = 1; //00001
	public static var CANCEL:Int = 2; //00010
	public static var YES:Int = 4; //00100
	public static var NO:Int = 8; //01000
	public static var CLOSE:Int = 16; //10000
	
	var okButton:JButton;
	var cancelButton:JButton;
	var yesButton:JButton;
	var noButton:JButton;
	var closeButton:JButton;
	
	var centerPane:JPanel;
	var msgLabel:JLabel;
	...
	function addCloseListener(button:JButton):Void{
	 ...
	 * @see #CLOSE
	 */
	public static function showMessageDialog(title:String, msg:String, ?finishHandler:Dynamic=null, 
        ?parentComponent:Component=null, ?modal:Bool=true, ?icon:Icon=null, 
        ?buttons:Int):JOptionPane{
		...
		pane.setIcon(icon);
		pane.frame = frame;
		var handler:Dynamic = finishHandler;
		if((buttons & OK) == OK){
	 ...
	 * @param icon the icon, can be null
	 */
	public static function showInputDialog(title:String, msg:String, ?finishHandler:Dynamic=null, ?defaultValue:String="", ?parentComponent:Component=null, ?modal:Bool=true, ?icon:Icon=null):JOptionPane{
		var frame:JFrame = new JFrame(AsWingUtils.getOwnerAncestor(parentComponent), title, modal);
		var pane:JOptionPane = new JOptionPane();
		if(defaultValue != ""){
		...
		var cancelHandler:Dynamic = function():Void{
