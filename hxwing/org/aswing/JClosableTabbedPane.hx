...
class JClosableTabbedPane extends JTabbedPane {
    ...
    var closeEnables:Array<Dynamic>;
	...
	override function insertProperties(i:Int, ?title:String="", ?icon:Icon=null, ?tip:String=null):Void{
		super.insertProperties(i, title, icon, tip);
		insertToArray(closeEnables, i, true);
	}
	
	override function removeProperties(i:Int):Void{
