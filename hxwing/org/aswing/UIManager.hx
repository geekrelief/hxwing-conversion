...
class UIManager
{
	...
	static var lookAndFeelDefaults:UIDefaults;
	static var lookAndFeel:LookAndFeel;
	...
	static function setLookAndFeelDefaults(d:UIDefaults):Void{
		lookAndFeelDefaults = d;
	}
	
	static function checkLookAndFeel():Void{
		if(lookAndFeel == null){
