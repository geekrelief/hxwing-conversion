...
class GridList extends JViewport, implements ListDataListener {
	...
	var tileHolder:GridCellHolder;
	var gridLayout:GridListLayout;
	
	var cellFactory:GridListCellFactory;
	var model:ListModel;
	...
	function createHolder(columns:Int, rows:Int):Container{
	...
	function createNewCell():GridListCell{
		return cellFactory.createNewGridListCell();
	}
	
	function addCellToContainer(cell:GridListCell, index:Int):Void{
		tileHolder.insert(index, cell.getCellComponent());
		addHandlersToCell(cell.getCellComponent());
	}
	
	function removeCellFromeContainer(cell:GridListCell):Void{
    ...
    var pressedIndex:Float;
    var pressedCtrl:Bool;
    var pressedShift:Bool;
    var doSelectionWhenRelease:Bool;    
    
    function __onItemMouseDownSelection(e:GridListItemEvent):Void{
    ...
    function __onItemClickSelection(e:GridListItemEvent):Void{
	...
	function createItemEventObj(cellCom:Dynamic, type:String, me:MouseEvent):GridListItemEvent{
