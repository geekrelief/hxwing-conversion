...
class Folder extends JPanel {
	 ...
	 */
	function changeTitleRepresentWhenStateChanged():Void{
		if(isExpanded()){
	...
	function __titleSelectionChanged(e:InteractiveEvent):Void{
	 ...
	 */
	public function addChangeListener(func:Dynamic, ?priority:Int=0, ?useWeekReference:Bool=false):Void{
	...
	public override function append(c:Component, ?constraints:Dynamic=null):Void{
