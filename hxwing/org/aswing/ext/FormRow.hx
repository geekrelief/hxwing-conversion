...
class FormRow extends JPanel, implements LayoutManager {
    ...
    var columns:ArrayList;
    var widthes:Array<Dynamic>;
	var columnVerticalAlignments:Array<Dynamic>;
	var gap:Int;
	var columnChildrenIndecis:String;
	...
	function appendChildren(arr:Array<Dynamic>):Void{
	...
	function __childrenChangedResetColumns(e:ContainerEvent):Void{
	...
	function getContinuousCount(column:Int):Int{
