...
class JColorChooser extends AbstractColorChooserPanel {
	...
	var chooserPanels:Array<Dynamic>;
	 ...
	 * @see #addChooserPanel()
	 */
	public function removeChooserPanelAt(index:Int):AbstractColorChooserPanel{
		return cast(getTabbedPane().removeAt(index), AbstractColorChooserPanel);
	}
	 ...
	 * @see #addChooserPanel()
	 */
	public function getChooserPanelAt(index:Int):AbstractColorChooserPanel{
		return cast(getTabbedPane().getComponent(index), AbstractColorChooserPanel);
	}
	 ...
	 */
	public function getChooserPanelCount():Int{
	...
	public static function showDialog(component:Component, title:String, initialColor:ASColor, ?modal:Bool=true, 
										?okHandler:Dynamic=null, ?cancelHandler:Dynamic=null, ?location:IntPoint=null):JColorChooser{
	...
	public static function createDialog(chooser:JColorChooser, component:Component, title:String, ?modal:Bool=true, 
										?okHandler:Dynamic=null, ?cancelHandler:Dynamic=null):JFrame{
		...
		frame.addEventListener(FrameEvent.FRAME_CLOSING, function(e:Dynamic):Void{
			if(cancelHandler != null) cancelHandler();
		});
		frame.pack();
		return frame;
