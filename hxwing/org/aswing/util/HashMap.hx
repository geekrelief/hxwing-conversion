...
class HashMap
 {
    ...
    var content:Hash<Dynamic>;
 	 ...
 	 */
 	public function eachKey(func:Dynamic):Void{
  		for(i in content.keys()){
  			func(i);
  		}
 	}
 	 ...
 	 * @param func the function to call
 	 */ 	
 	public function eachValue(func:Dynamic):Void{
  		for (i in content){
  			func(i);
  		}
 	}
     ...
     *	       <tt>null</tt> with the specified key.
 	...
 	public function put(key:Dynamic, value:Dynamic):Dynamic{
  		if(key == null){
   			...
   			throw ("cannot put a value with undefined or null key!");
   			return null;
  		}else if(value == null){
  			return remove(key);
  		}else{
