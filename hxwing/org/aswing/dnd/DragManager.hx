...
class DragManager {
	...
	public static var TYPE_MOVE:Int = 1;
	public static var TYPE_COPY:Int = 2;
	...
	static var s_isDragging:Bool = false;
	
	static var s_dragListener:DragListener;
	static var s_dragInitiator:Component;
	static var s_sourceData:SourceData;
	static var s_dragImage:DraggingImage;
	
	static var root:DisplayObjectContainer = null;
	static var dropMotion:DropMotion;
	static var runningMotion:DropMotion;
	static var dragProxyMC:Sprite;
	static var mouseOffset:IntPoint;
	static var enteredComponent:Component;
	
	static var listeners:Array<Dynamic> = new Array();
	...
	static function ____dropTargetCheck(tar:Component):Bool{
	...
	public static function getDropTarget(stage:Stage, ?pos:Point=null, 
		...
		?addtionCheck:Dynamic=null):DisplayObject{
		if(stage == null){
			return null;
		}
		if(pos == null){
	...
	static function __onMouseMoveOnStage(stage:Stage):Void{
		onMouseMove(stage.mouseX, stage.mouseY);
	}
	
	static function onMouseMove(mx:Float, my:Float):Void{
	...
	static function __onMouseMove(e:MouseEvent):Void{
		onMouseMove(e.stageX, e.stageY);
	}
	
	static function __onMouseUp(e:MouseEvent):Void{
		drop();
	}
	
	static function __onMouseDown(e:MouseEvent):Void{
		drop(); 
	...
	static function fireDragStartEvent(dragInitiator:Component, sourceData:SourceData, pos:IntPoint):Void{
	...
	static function fireDragEnterEvent(dragInitiator:Component, sourceData:SourceData, pos:IntPoint, targetComponent:Component, relatedTarget:Component):Void{
		var e:DragAndDropEvent = new DragAndDropEvent(
	...
	static function fireDragOverringEvent(dragInitiator:Component, sourceData:SourceData, pos:IntPoint, targetComponent:Component):Void{
		var e:DragAndDropEvent = new DragAndDropEvent(
	...
	static function fireDragExitEvent(dragInitiator:Component, sourceData:SourceData, pos:IntPoint, targetComponent:Component, relatedTarget:Component):Void{
		var e:DragAndDropEvent = new DragAndDropEvent(
	...
	static function fireDragDropEvent(dragInitiator:Component, sourceData:SourceData, pos:IntPoint, targetComponent:Component):Void{
		var e:DragAndDropEvent = new DragAndDropEvent(
