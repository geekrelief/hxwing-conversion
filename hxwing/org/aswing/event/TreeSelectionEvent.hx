...
class TreeSelectionEvent extends InteractiveEvent {
     ...
     *  @eventType treeSelectionChanged
	 */
	public static var TREE_SELECTION_CHANGED:String = "treeSelectionChanged";		
    ...
    var areNew:Array<Dynamic>; //boolean[]
    /** leadSelectionPath before the paths changed, may be null. */
    var oldLeadSelectionPath:TreePath;
    /** leadSelectionPath after the paths changed, may be null. */
    var newLeadSelectionPath:TreePath;
    ...
    public function isAddedPathOfIndex(index:Int):Bool {
		if (paths == null || index < 0 || index >= paths.length) {
		    ...
		    throw ("index is beyond range of added paths identified by TreeSelectionEvent");
		}
