...
class DragAndDropEvent extends AWEvent {
     ...
     *  @eventType dragRecongnized
	 */
	public static var DRAG_RECOGNIZED:String = "dragRecognized";	
     ...
     *  @eventType dragEnter
	 */
	public static var DRAG_ENTER:String = "dragEnter";	
	 ...
	 */
	public static var DRAG_OVERRING:String = "dragOverring";	
     ...
     *  @eventType dragExit
	 */
	public static var DRAG_EXIT:String = "dragExit";	
	...
	var mousePos:IntPoint;
	var targetComponent:Component;
	var relatedTargetComponent:Component;
