...
class FocusKeyEvent extends KeyboardEvent {
     ...
     *  @eventType focusKeyDown
	 */	 
	public static var FOCUS_KEY_DOWN:String = "focusKeyDown";
	 ...
	 */	 	 
	public static var FOCUS_KEY_UP:String = "focusKeyUp";		
	
	public function new(type:String, ?charCode:UInt=0, ?keyCode:UInt=0, ?keyLocation:flash.ui.KeyLocation, ?ctrlKey:Bool=false, ?altKey:Bool=false, ?shiftKey:Bool=false){
        if(keyLocation == null) {
            keyLocation = flash.ui.KeyLocation.STANDARD;
        }
