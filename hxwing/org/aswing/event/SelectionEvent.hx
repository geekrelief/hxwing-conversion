...
class SelectionEvent extends InteractiveEvent {
     ...
     *  @eventType listSelectionChanged
	 */
	public static var LIST_SELECTION_CHANGED:String = "listSelectionChanged";
	 ...
	 */
	public static var ROW_SELECTION_CHANGED:String = "rowSelectionChanged";	
	 ...
	 */
	public static var COLUMN_SELECTION_CHANGED:String = "columnSelectionChanged";	
