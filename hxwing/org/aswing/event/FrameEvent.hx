...
class FrameEvent extends InteractiveEvent {
     ...
     *  @eventType frameIconified
	 */
	public static var FRAME_ICONIFIED:String = "frameIconified";
	 ...
	 */
	public static var FRAME_RESTORED:String = "frameRestored";	
	 ...
	 */
	public static var FRAME_MAXIMIZED:String = "frameMaximized";
	 ...
	 */
	public static var FRAME_ABILITY_CHANGED:String = "frameAbilityChanged";	
	 ...
	 */
	public static var FRAME_CLOSING:String = "frameClosing";
