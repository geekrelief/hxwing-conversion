...
class TableCellEditEvent extends AWEvent {
     ...
     *  @eventType tableCellEditingStarted
	 */
	public static var EDITING_STARTED:String = "tableCellEditingStarted";	
	 ...
	 */
	public static var EDITING_CANCELED:String = "tableCellEditingCanceled";
	 ...
	 */
	public static var EDITING_STOPPED:String = "tableCellEditingStopped";
