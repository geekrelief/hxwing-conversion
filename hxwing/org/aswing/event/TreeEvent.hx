...
class TreeEvent extends AWEvent {
     ...
     *  @eventType treeExpanded
	 */
	public static var TREE_EXPANDED:String = "treeExpanded";
	 ...
	 */
	public static var TREE_COLLAPSED:String = "treeCollapsed";
	 ...
	 */
	public static var TREE_WILL_EXPAND:String = "treeWillExpand";
	 ...
	 */
	public static var TREE_WILL_COLLAPSE:String = "treeWillCollapse";	
