...
class AWEvent extends Event {
     ...
     *  @eventType act
	 */
	public static var ACT:String = "act";
     ...
     *  @eventType shown
	 */
	public static var SHOWN:String = "shown";
     ...
     *  @eventType paint
	 */
	public static var PAINT:String = "paint";
	 ...
	 */	 
	public static var FOCUS_GAINED:String = "focusGained";
