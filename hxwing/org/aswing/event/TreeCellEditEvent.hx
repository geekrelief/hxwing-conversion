...
class TreeCellEditEvent extends AWEvent {
     ...
     *  @eventType treeCellEditingStarted
	 */
	public static var EDITING_STARTED:String = "treeCellEditingStarted";	
	 ...
	 */
	public static var EDITING_CANCELED:String = "treeCellEditingCanceled";
	 ...
	 */
	public static var EDITING_STOPPED:String = "treeCellEditingStopped";
