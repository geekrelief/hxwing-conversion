...
class BevelBorder extends DecorateBorder {
    ...
    /** Raised bevel type. */
    public static var RAISED:Int  = 0;
    /** Lowered bevel type. */
    public static var LOWERED:Int = 1;

    var bevelType:Int;
    var highlightOuter:ASColor;
    var highlightInner:ASColor;
    var shadowInner:ASColor;
    var shadowOuter:ASColor;
    var thickness:Float;
     ...
     */
    public function new(?interior:Border=null, ?bevelType:Int, ?highlightOuterColor:ASColor=null, 
                       ?highlightInnerColor:ASColor=null, ?shadowOuterColor:ASColor=null, 
                       ?shadowInnerColor:ASColor=null, ?thickness:Int=2) {
    ...
    function paintRaisedBevel(c:Component, g:Graphics2D, x:Float, y:Float,
                                    width:Float, height:Float):Void  {
        var h:Int = height;
        var w:Int = width;
        var pt:Int = thickness/2;
        x += pt/2;
        y += pt/2;
        w -= pt;
        h -= pt;
    ...
    function paintLoweredBevel(c:Component, g:Graphics2D, x:Float, y:Float,
                                    width:Float, height:Float):Void  {
        var h:Int = height;
        var w:Int = width;
        var pt:Int = thickness/2;
