...
class DefaultTreeModel implements TreeModel {
    ...
    public function nodesWereInserted(node:TreeNode, childIndices:Array<Dynamic>):Void {
        if(listenerList != null && node != null && childIndices != null && childIndices.length > 0) {
            ...
            var newChildren:Array<Dynamic> = new Array();
    ...
    public function nodesChanged(node:TreeNode, childIndices:Array<Dynamic>):Void {
        if(node != null) {
			if (childIndices != null) {
				var cCount:Int = childIndices.length;
				if(cCount > 0) {
			    	var cChildren:Array<Dynamic> = new Array();
	 				for(counter in 0...cCount){
     ...
     *         specified node 
     */
    function getPathToRoot(aNode:TreeNode, ?depth:Int=0):Array<Dynamic> {
     ...
     */
    function fireTreeNodesChanged(source:Dynamic, path:Array<Dynamic>, 
     ...
     * @see EventListenerList
     */
    function fireTreeNodesInserted(source:Dynamic, path:Array<Dynamic>, 
                                        childIndices:Array<Dynamic>, 
                                        children:Array<Dynamic>):Void {
        var listeners:Array<Dynamic> = listenerList;
        var e:TreeModelEvent = null;
     ...
     * @see EventListenerList
     */
    function fireTreeNodesRemoved(source:Dynamic, path:Array<Dynamic>, 
                                        childIndices:Array<Dynamic>, 
                                        children:Array<Dynamic>):Void {
        var listeners:Array<Dynamic> = listenerList;
        var e:TreeModelEvent = null;
     ...
     * @see EventListenerList
     */
    function fireTreeStructureChanged(source:Dynamic, path:Array<Dynamic>, 
                                        childIndices:Array<Dynamic>, 
                                        children:Array<Dynamic>):Void {
        var listeners:Array<Dynamic> = listenerList;
        var e:TreeModelEvent = null;
     ...
     * @see EventListenerList
     */
    function fireTreeStructureChanged2(source:Dynamic, path:TreePath):Void {
        var listeners:Array<Dynamic> = listenerList;
        var e:TreeModelEvent = null;
        // Process the listeners last to first, notifying
        // those that are interested in this event
