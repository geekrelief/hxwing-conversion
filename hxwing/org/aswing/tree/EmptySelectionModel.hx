...
class EmptySelectionModel extends DefaultTreeSelectionModel {
    ...
    static var _sharedInstance:EmptySelectionModel;
    ...
    public override function setSelectionPaths(pPaths:Array<Dynamic>, ?programmatic:Bool=true):Void {}
    /** A <code>null</code> implementation that adds nothing. */
    public override function addSelectionPaths(pPaths:Array<Dynamic>, ?programmatic:Bool=true):Void {}
    /** A <code>null</code> implementation that removes nothing. */
    public override function removeSelectionPaths(pPaths:Array<Dynamic>, ?programmatic:Bool=true):Void {}
}
