...
interface TreeSelectionModel{
     ...
     */
    function addPropertyChangeListener(listener:Dynamic, ?priority:Int=0, ?useWeakReference:Bool=false):Void;
    ...
    /**
      ...
      */
    function addTreeSelectionListener(listener:Dynamic, ?priority:Int=0, ?useWeakReference:Bool=false):Void;
