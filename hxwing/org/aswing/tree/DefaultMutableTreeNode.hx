...
class DefaultMutableTreeNode implements MutableTreeNode {
    ...
    var _children:ArrayList;

    /** optional user object */
    var userObject:Dynamic;
     ...
     *         specified node 
     */
    function getPathToRoot(aNode:TreeNode, depth:Int):Array<Dynamic> {
    ...
    public function getUserObjectPath():Array<Dynamic> {
		...
		var retPath:Array<Dynamic> = new Array();
    ...
    function fillPreorder(node:TreeNode, arr:Array<Dynamic>):Void{
    	arr.push(node);
    ...
    function fillPostorder(node:TreeNode, arr:Array<Dynamic>):Void{
    	var cd:Array<Dynamic> = node.children();
    	if(cd != null && cd.length > 0){
    		for(i in 0...cd.length){
    ...
    public function breadthFirstEnumeration():Array<Dynamic> {
		var arr:Array<Dynamic> = new Array();
		var queue:Array<Dynamic> = new Array();
		queue.push(this);
    ...
    public function isNodeSibling(anotherNode:TreeNode):Bool {
		...
		if (anotherNode == null) {
		    ...
		    if (retval && !(mp.isNodeChild(anotherNode))) {
				...
				throw ("sibling has different parent");
		    }
		}
    ...
    public function getNextSibling():DefaultMutableTreeNode {
		...
		if (retval != null && !isNodeSibling(retval)) {
		   ...
		   //throw new Error("child of parent is not a sibling");
		    throw ("child of parent is not a sibling");
		}
