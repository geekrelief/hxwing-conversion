...
class FHTreeStateNode extends DefaultMutableTreeNode {
	...
	var layoutCache:FixedHeightLayoutCache;
	 ...
	 */
	public override function setUserObject(o:Dynamic):Void {
	...
	public function getChildAtModelIndex(index:Int):FHTreeStateNode {
	    ...
	    var counter:Int = getChildCount() - 1;
		while (counter >= 0){
	 ...
	 */
	function resetChildrenPaths(parentPath:TreePath):Void {
	 ...
	 * table.
	 */
	function removeFromMapping():Void {
	    if(path != null) {
			layoutCache.removeMapping(this);
			var counter:Int = getChildCount() - 1;
			   while (counter >= 0){
	 ...
	 */
	function setRowAndChildren(nextRow:Int):Int {
	    row = nextRow;
	 ...
	 */
	function expandParentAndReceiver():Void {
	    var parent:FHTreeStateNode = cast(getParent(), FHTreeStateNode);
	 ...
	 */
	public override function isLeaf():Bool {
	 ...
	 */
	function adjustChildIndexs(index:Int, amount:Int):Void {
	 ...
	 */
	function getCountTo(stopIndex:Int):Int {
	    var aChild:FHTreeStateNode;
