...
class TreeFolderIcon implements Icon, implements UIResource {
	...
	public function updateIcon(com:Component, g:Graphics2D, x:Int, y:Int):Void {
		...
		// Draw back face
		var flapSize:UInt = 5;
		var backPoints:Array<Dynamic> = new Array();
    ...
    var colors:Array<Dynamic> = [0xE6E9EE, 0x8E94BD];
    ...
    g.fillPolygon(brush, backPoints);
		...
		g.drawPolygon( new Pen( borderColor, 0 ), frontPoints );
