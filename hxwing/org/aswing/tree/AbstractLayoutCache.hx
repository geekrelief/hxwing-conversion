...
class AbstractLayoutCache implements RowMapper {
    ...
    /** Object responsible for getting the size of a node. */
    var nodeDimensions:NodeDimensions;

    /** Model providing information. */
    var treeModel:TreeModel;

    /** Selection model. */
    var treeSelectionModel:TreeSelectionModel;
    ...
    public function getPreferredWidth(bounds:IntRectangle):Int {
		...
		if(rowCount > 0) {
		    ...
		    var paths:Array<Dynamic> = getVisiblePathsFrom(firstPath, Ints.MAX);
     ...
     */
    function countNodeDimensions(value:Dynamic, row:Int, depth:Int,
