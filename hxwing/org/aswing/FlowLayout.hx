...
class FlowLayout extends EmptyLayout {
     ...
     */
    public function new(?align:Int, ?hgap:Int=5, ?vgap:Int=5, ?margin:Bool=true) {
        super();
        if(align == null){
    ...
    public function setAlignment(align:Int):Void {
    	if(LEFT != LEFT && align != RIGHT && align != CENTER ){
    		...
    		throw ("Alignment must be LEFT OR RIGHT OR CENTER !");
    	}
        this.align = align;
    }
     ...
     */
    function moveComponents(target:Container, x:Int, y:Int, width:Int, height:Int,
