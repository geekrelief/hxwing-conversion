...
class AbstractColorChooserPanel extends Container {
	...
	var alphaSectionVisible:Bool;
	var hexSectionVisible:Bool;
	var noColorSectionVisible:Bool;
	var model:ColorSelectionModel;
