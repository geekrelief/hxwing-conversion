...
class ResizerController {
	...
	static var defaultResizerClass:Class<Dynamic>;
	
	var _component: Component;
	
	var _resizer: Resizer;
	var _resizable: Bool;
	var _resizableDirectly: Bool;
	...
	public function new( comp : Component , ?resizer:Resizer=null)
	{
		if(comp == null) 
		{
			...
			throw ("illegal component when insert to ResizerContainer");
		}
		else
		{
	 ...
	 * @param resizer the resizer, default is null means to create a default one.
	 */
	function _registerComponent( comp : Component , ?resizer:Resizer=null) : Void
	{
		_component = comp;
