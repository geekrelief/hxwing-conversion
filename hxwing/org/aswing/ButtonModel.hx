...
interface ButtonModel
{
	 ...
	 */
	function addStateListener(listener:Dynamic, ?priority:Int=0, ?useWeakReference:Bool=false):Void;
	 ...
	 */
	function addActionListener(listener:Dynamic, ?priority:Int=0, ?useWeakReference:Bool=false):Void;
	 ...
	 */	
	function addSelectionListener(listener:Dynamic, ?priority:Int=0, ?useWeakReference:Bool=false):Void;
