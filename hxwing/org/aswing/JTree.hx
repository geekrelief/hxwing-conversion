...
class JTree extends Container, implements Viewportable, implements TreeModelListener, implements CellEditorListener {
    ...
    /** Selection can only contain one path at a time. */
    public static var SINGLE_TREE_SELECTION:Int = DefaultTreeSelectionModel.SINGLE_TREE_SELECTION;
    ...
    public static var CONTIGUOUS_TREE_SELECTION:Int = DefaultTreeSelectionModel.CONTIGUOUS_TREE_SELECTION;

    /** Selection can contain any number of items that are not necessarily
     * contiguous. */
    public static var DISCONTIGUOUS_TREE_SELECTION:Int = DefaultTreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION;
	
 	/**
 	 * The default unit/block increment, it means auto count a value.
 	 */
 	public static var AUTO_INCREMENT:Int = Ints.MIN;
     ...
     */
    var expandedStack:Stack;

    /**
     * Lead selection path, may not be <code>null</code>.
     */
    var leadPath:TreePath;

    /**
     * Anchor path.
     */
    var anchorPath:TreePath;
     ...
     */
    static var TEMP_STACK_SIZE:Int = 11;
     ...
     */
    static function getDefaultTreeModel():TreeModel {
    ...
    public override function setFont(f:ASFont):Void{
    ...
    public function setSelectionRows(rows:Array<Dynamic>, ?programmatic:Bool=true):Void {
        ...
        if(ui != null && rows != null) {
            ...
            var paths:Array<Dynamic> = new Array();
    ...
    public function getExpandedDescendants(parent:TreePath):Array<Dynamic> {
		...
		if(toggledPaths != null) {
			for(i in 0...toggledPaths.length){
				path = cast(toggledPaths[i], TreePath);
     ...
     *		if there is no tree
     */
    function getPathBetweenRows(index0:Int, index1:Int):Array<Dynamic> {
        ...
        if(tree != null) {
            var selection:Array<Dynamic> = new Array();

            var counter:Int = newMinIndex;
               while (counter <= newMaxIndex){
    ...
    */
    ...
    function firePropertyChange(pn:String, oldValue:Dynamic, newValue:Dynamic):Void{
     ...
     */
    function getModelIndexsForPath(path:TreePath):Array<Dynamic> {
		if(path != null) {
		    var model:TreeModel = getModel();
		    var count:Int = path.getPathCount();
		    var indexs:Array<Dynamic> = new Array();
     ...
     * <code>null</code>.
     */
    function getPathForIndexs(indexs:Array<Dynamic>):TreePath {
		if(indexs == null)
		    return null;
     ...
     */
    function setExpandedState(path:TreePath, state:Bool):Void {
		if(path != null) {
     ...
     */
    function getDescendantToggledPaths(parent:TreePath):Array<Dynamic>{
		if(parent == null)
		    return null;
	
		var descendants:Array<Dynamic> = new Array();
		var nodes:Array<Dynamic> = expandedState.keys();
		var path:TreePath;
	
		for(i in 0...nodes.length){
		    path = cast(nodes[i], TreePath);
     ...
     */
	function removeDescendantToggledPaths(toRemove:Array<Dynamic>):Void{
		if(toRemove != null) {
      ...
      */
     function clearToggledPaths():Void {
	 	expandedState.clear();
     }
     ...
     */
    function removeDescendantSelectedPaths(path:TreePath, includePath:Bool):Bool {
     ...
     */
    function getDescendantSelectedPaths(path:TreePath, includePath:Bool):Array<Dynamic> {
     ...
     *		<code>TreeSelectionModel</code>
     */
    function __valueChangedTreeSelectionRedirector(e:TreeSelectionEvent):Void {
		dispatchEvent(e.cloneWithSource(this));
    }
	...
	public function treeNodesRemoved(e : TreeModelEvent) : Void {
	    ...
	    var rPath:TreePath;
	    var toRemove:Array<Dynamic> = new Array();
