...
class BoxLayout extends EmptyLayout {
     ...
     * Specifies that components should be laid out left to right.
     */
    public static var X_AXIS:Int = AsWingConstants.HORIZONTAL;
    
    /**
     * Specifies that components should be laid out top to bottom.
     */
    public static var Y_AXIS:Int = AsWingConstants.VERTICAL;
     ...
     * @see #X_AXIS
     */
    public function new(?axis:Int, ?gap:Int=0){
        super();
        if(axis == null){
            axis = X_AXIS;
        }
    ...
    function getCommonLayoutSize(target:Container, isMax:Bool):IntDimension{
