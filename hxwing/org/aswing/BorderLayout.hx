...
class BorderLayout extends EmptyLayout {
    ...
    var firstLine:Component;

	var lastLine:Component;

	var firstItem:Component;
    ...
    function addLayoutComponentByAlign(name:String, comp:Component):Void {
		if (name == null) {
     ...
     */
    function getChild(key:String, ltr:Bool):Component {
